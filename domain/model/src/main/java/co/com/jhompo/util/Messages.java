...
public final class Messages {
    ...
    public static final class SYSTEM {
        ...
        // Mensajes relacionados con status y amount
        public static final String STATUS_LOG = "status: {}";
        public static final String APPROVED_AMOUNT_DETECTED = "Monto aprobado detectado: {} para préstamo ID: {}";
        public static final String COUNTER_INCREMENTED = "Contador incrementado a: {}";
        ...
        public static final String COUNTER_ERROR = "Error al incrementar el contador: {}";
        public static final String INVALID_AMOUNT_WARNING = "Mensaje SQS no contiene un 'amount' válido. Contenido: {}";
        public static final String NULL_AMOUNT_WARNING = "El campo 'amount' es nulo. Contenido: {}";

        // Mensajes de error al parsear JSON o excepciones
        public static final String JSON_PARSE_ERROR = "Error al parsear el mensaje JSON de SQS: {}";
        public static final String JSON_CONTENT_ERROR = "Contenido del mensaje que falló: {}";
        public static final String UNEXPECTED_PROCESSING_ERROR = "Error inesperado procesando mensaje SQS: {}";
